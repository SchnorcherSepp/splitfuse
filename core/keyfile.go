...
// CalcChunkCryptHash generiert den Dateinamen eines Chunks. Es muss dafür der hash über den Klartext des Chunks
// übergeben werden und es wird der verschlüsselte, 512 Bits lange Name zurück gegeben.
func (k *KeyFile) CalcChunkCryptHash(chunkHash []byte) []byte {
